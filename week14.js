...
// const myInformation = ["Алена", 25, "август", "Дева"];
...
// const lastCountry = countries.shift();
...
// const russianCitiesNew = ['Санкт-Петербург', 'Москва', 'Екатеринбург', ...russianCities];
// console.log(russianCitiesNew);
...
//     const numbersNew = numbers.filter(el=>el % 2 === 0);
//     return numbersNew;
// };
